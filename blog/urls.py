...
urlpatterns = [
  ...
  path('blog/<int:blog_id>/comment/update/<int:comment_id>', views.comment_update, name='comment_update'),
  path('blog/<int:blog_id>/comment/delete/<int:comment_id>', views.comment_delete, name='comment_delete'),
